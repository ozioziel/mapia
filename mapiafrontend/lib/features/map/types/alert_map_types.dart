...
extension AlertTypeApi on AlertType {
  String get apiValue => switch (this) {
    ...
    AlertType.celebracion => 'celebracion',
    AlertType.fiesta => 'fiesta',
    AlertType.eventoComunitario => 'evento_comunitario',
    AlertType.conciertoLibre => 'concierto_libre',
    AlertType.feria => 'feria',
    AlertType.entradaFolklorica => 'entrada_folklorica',
    AlertType.descuento => 'descuento',
    AlertType.promocion => 'promocion',
    AlertType.marcha => 'marcha',
    AlertType.transporte => 'transporte',
    AlertType.abastecimiento => 'abastecimiento',
    AlertType.seguridad => 'seguridad',
    AlertType.cultura => 'cultura',
    AlertType.deporte => 'deporte',
    AlertType.salud => 'salud',
    AlertType.emergencia => 'emergencia',
    AlertType.servicioPublico => 'servicio_publico',
    AlertType.otro => 'otro',
  };
  ...
  String get label => switch (this) {
    ...
    AlertType.celebracion => 'Celebración',
    AlertType.fiesta => 'Fiesta',
    AlertType.eventoComunitario => 'Evento',
    AlertType.conciertoLibre => 'Concierto',
    AlertType.feria => 'Feria',
    AlertType.entradaFolklorica => 'Entrada Folklorica',
    AlertType.descuento => 'Descuento',
    AlertType.promocion => 'Promoción',
    AlertType.marcha => 'Marcha',
    AlertType.transporte => 'Transporte',
    AlertType.abastecimiento => 'Abastecimiento',
    AlertType.seguridad => 'Seguridad',
    ...
    AlertType.salud => 'Salud',
    AlertType.emergencia => 'Emergencia',
    AlertType.servicioPublico => 'Servicio Público',
    AlertType.otro => 'Otro',
  };
}

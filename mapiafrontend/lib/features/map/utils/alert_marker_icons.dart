...
class AlertMapMarkerIcons {
  ...
  static AlertSeverity _defaultSeverity(AlertType type) {
    return switch (type) {
      ...
      AlertType.celebracion => AlertSeverity.low,
      AlertType.fiesta => AlertSeverity.low,
      AlertType.eventoComunitario => AlertSeverity.normal,
      AlertType.conciertoLibre => AlertSeverity.low,
      AlertType.feria => AlertSeverity.low,
      AlertType.entradaFolklorica => AlertSeverity.medium,
      AlertType.descuento => AlertSeverity.low,
      AlertType.promocion => AlertSeverity.low,
      AlertType.marcha => AlertSeverity.medium,
      AlertType.transporte => AlertSeverity.medium,
      AlertType.abastecimiento => AlertSeverity.normal,
      AlertType.seguridad => AlertSeverity.high,
      AlertType.cultura => AlertSeverity.normal,
      AlertType.deporte => AlertSeverity.normal,
      AlertType.salud => AlertSeverity.high,
      AlertType.emergencia => AlertSeverity.high,
      AlertType.servicioPublico => AlertSeverity.normal,
